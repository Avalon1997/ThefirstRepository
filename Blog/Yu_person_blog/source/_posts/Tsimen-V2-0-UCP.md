...
**Tsimen-2000 端返回值：** 积分时间：00 00 01 F4 {4字节积分时间数据}
**响应时间：** 30 ms
...
**Tsimen-2000 端返回值：** 平均次数：00 32 {2字节平均册数数据}  
**响应时间：** 30 ms

#### Ⅶ. 读取暗电流条件下光谱仪数据

**上位机发送：** 01 07 00 00 00 00 0A B4  
**Tsimen-2000 端返回值：** <font color='red'>暗信号数据见附录1</font>  
**响应时间：** 2500 ms

#### Ⅷ. 读取参考信号条件下光谱仪数据

**上位机发送：** 01 08 00 00 00 00 0B E0  
**Tsimen-2000 端返回值：** <font color='red'>参考信号数据见附录2</font>  
**响应时间：** 2500 ms

#### Ⅸ. 读取样品信号条件下光谱仪数据

**上位机发送：** 01 09 00 00 00 00 CB DD  
**Tsimen-2000 端返回值：** <font color='red'>样品信号数据见附录3</font>  
**响应时间：** 2500 ms
